...
SecureBrowserClient::SecureBrowserClient() : tab_manager_(new TabManager()),
    ...
    // Initialize Secure Permission Handler
    permission_handler_ = new SecurePermissionHandler();
}
...
CefRefPtr<CefPermissionHandler> SecureBrowserClient::GetPermissionHandler() {
